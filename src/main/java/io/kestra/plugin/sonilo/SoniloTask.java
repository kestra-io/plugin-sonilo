    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.sonilo.SoniloTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class SoniloTask extends Task implements RunnableTask<SoniloTask.Output> {
    @Schema(
    ...
    @Override
    public SoniloTask.Output run(RunContext runContext) throws Exception {
